...
#
# Modified rendering of <i>, <blockquote>, and <script> by Kare Sjolander
;# RCSID: $Header: /afs/md.kth.se/tmh/misc/cvsroot/wavesurfer/src/htmllib.tcl,v 1.11 2005/03/15 13:46:18 kare Exp $
#
...
set HMtag_map(hmstart) {
	family arial   weight medium   style r   size 10
...
proc HMtag_script {win param text} {
	upvar $text data
	set data ""
}
